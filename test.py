...
def validate_amount(main_root):
    ...
    if error != "":
        ...
        #         # if re.match(r'^(0[0-9]{2}|100)\b(?!\.\d)', line.strip()):
        ...
        def process_pdf(pdf_file):
            ...
            try:
                ...
                # total_duty_other_fee = 0.0  # Initialize default
                ...
                # Validate เพื่อน Validate and build report
                output = ""
                ...
                for invoice, fob in invoice_fob_list:
                    if invoice not in entry_summary_invoices:
                        output += f"Invoice No {invoice} not Present in Entry sheet\n"
                        continue
