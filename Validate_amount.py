                    ...
                    # print("stored_latest1:",stored_latest)
                        ...
                        if type(result2['check2'])==list:
                            ...
                            for var in result2['check2']:
                                ...
                                key_str = text[0].split()[0]
                                try:
                                    key = int(key_str)
                                except ValueError:
                                    print("Skipped invalid key:", key_str)
                                    continue
                                ...
                                # fifth  = text[4].replace('501 - Harbor Maintenance Fee','').split()
                                fifth_line = text[4]
                                fifth_line = re.sub(r'501\s*-\s*Harbor\s*Maintenance\s*Fee', '', fifth_line)
                                fifth = fifth_line.split()
